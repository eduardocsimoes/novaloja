	...
	<body>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo BASE_URL.'language/set/en'; ?>">English</a></li>
							<li><a href="<?php echo BASE_URL.'language/set/pt-br'; ?>">Português</a></li>
							<li><a href="<?php echo BASE_URL.'language/set/es'; ?>">Espanhol</a></li>
						</ul>
					</li>
					...
					<ul class="nav navbar-nav">
						<li class="dropdown">
					        ...
					        <ul class="dropdown-menu">
								<?php foreach($viewData['categories'] as $categories){ ?>
									<li>
										<a href="<?php echo BASE_URL; ?>categories/enter/<?php echo $categories['id']; ?>"><?php echo $categories['name']; ?></a>
									</li>
									<?php if(count($categories['subs']) > 0){
	    ...
	    <footer>
	    			...
	    			<div class="row">
						...
						<div class="col-sm-8 linkgroups">
							<div class="row">
								...
								<div class="col-sm-4">
									<h3><?php $this->language->get('INFORMATION'); ?></h3>
									<ul>
	    	...
	    	<div class="copyright">
	    		<div class="container">
	    			<div class="row">
						<div class="col-sm-6">© <span>Loja 2.0</span> - <?php $this->language->get('ALLRIGHTSRESERVED'); ?>.</div>
						<div class="col-sm-6">
							<div class="payments">
		...
		<script type="text/javascript">
			...
			<?php if($viewData['filters']['maxslider']){ ?>
